...
# Moving into the 'gauto' directory, symbolic links are made to micrographs
cd gauto
...
/programs/x86_64-linux/gautomatch/0.53/bin/Gautomatch-v0.53_sm_20_cu7.5_x86_64 --apixM $apixM --diameter $diameter_var *.mrc
